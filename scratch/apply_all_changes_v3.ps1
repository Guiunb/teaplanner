...
# Emojis as character code points
...
$newContextMenuHtml = '        <button data-action="date">' + $calEmoji + ' Editar Data <span class="shortcut">Alt+D</span></button>' + "`r`n" + '        <button data-action="agenda">' + $calEmoji + ' Agendar / Recorrência...</button>' + "`r`n" + '        <button data-action="alert">' + $bellEmoji + ' Configurar Alerta...</button>'
