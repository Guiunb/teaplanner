...
# Define newLines using single quotes to avoid PowerShell variable and backtick interpolation
$newLines = @(
...
Write-Host "SUCCESS: Replaced subscribeToCurrentBoard via lines manipulation (fixed backticks)!"
